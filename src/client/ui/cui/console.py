...
# for static calls
from client.config import version as e_config_version
...
class Console(cmd_base.Cmd, qt_core.QObject, AppBase):
    ...
    def __init__(self, gcd):
        ...
        self.gcd = gcd
        self.intro = self.tr(f'Welcome to {e_config_version.CLIENT_NAME}.\tType help or ? to list commands.\n')
