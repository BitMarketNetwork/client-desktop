...
from client import gcd, key_manager
from client.wallet import address, coin_network, coins, hd, key
from client.wallet.database import db_wrapper, encrypt_proxy
...
class TestWorkflow(unittest.TestCase):
    ...
    def test_addresses(self):
        ...
        self.db._add_or_save_wallet(addr, None)
