...
class _Address(Coin.Address):
    ...
    @classmethod
    def createFromName(
        cls, coin: Bitcoin, *, name: str, **kwargs
    ) -> Optional[_Address]:
        ...
        if type_ in (cls.Type.PUBKEY_HASH, cls.Type.SCRIPT_HASH):
...
class _TestAddress(_Address):
    ...
    class Type(Coin.Address.Type):
        UNKNOWN: Final = _Address.Type.UNKNOWN.value
        PUBKEY_HASH: Final = _Address.Type.PUBKEY_HASH.value.copy(version=0x6F)
        SCRIPT_HASH: Final = _Address.Type.SCRIPT_HASH.value.copy(version=0xC4)
        WITNESS_V0_KEY_HASH: Final = _Address.Type.WITNESS_V0_KEY_HASH.value
        WITNESS_V0_SCRIPT_HASH: Final = (
            _Address.Type.WITNESS_V0_SCRIPT_HASH.value
        )
        WITNESS_UNKNOWN: Final = _Address.Type.WITNESS_UNKNOWN.value
        DEFAULT = WITNESS_V0_KEY_HASH
